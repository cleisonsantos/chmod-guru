import{j as d,r as a,s as u,W as h,R as p,a as x}from"./vendor.113ef8a1.js";const g=function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))n(r);new MutationObserver(r=>{for(const i of r)if(i.type==="childList")for(const c of i.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&n(c)}).observe(document,{childList:!0,subtree:!0});function s(r){const i={};return r.integrity&&(i.integrity=r.integrity),r.referrerpolicy&&(i.referrerPolicy=r.referrerpolicy),r.crossorigin==="use-credentials"?i.credentials="include":r.crossorigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(r){if(r.ep)return;r.ep=!0;const i=s(r);fetch(r.href,i)}};g();const e=d.exports.jsx,l=d.exports.jsxs,f=d.exports.Fragment,m=a.exports.createContext({}),y=()=>a.exports.useContext(m),b=({children:o})=>{const[t,s]=a.exports.useState(""),n=r=>{s(r)};return e(m.Provider,{value:{permission:t,handlePermission:n},children:o})},v=u.input`
...
`,E=u.main`
    ...
    min-height: 100vh;
`;function I(){return l(f,{children:[e(C,{}),e(b,{children:l(E,{children:[e("h1",{children:"Chmod Guru!!!"}),e("p",{children:"Um simples utilit\xE1rio para saber qual permiss\xE3o \xE9 do Linux!!!"}),e(P,{}),e(S,{})]})})]})}p.render(e(x.StrictMode,{children:e(I,{})}),document.getElementById("root"));
